...
def default_files() -> list[Path]:
    candidates = [
        ROOT / "crawl_zol.py",
        ROOT / "crawl_pconline.py",
        ROOT / "merge_phones.py",
        ROOT / "search_root_info.py",
        ROOT / "proxy_manager.py",
        ROOT / "custom_scripts/setup_proxy_runtime.py",
        ROOT / "custom_scripts/configure_cron_job_org.py",
        ROOT / "custom_scripts/crawl_budget.py",
        ROOT / "custom_scripts/git_sync_progress.sh",
        ROOT / "custom_scripts/merge_progress_json.py",
        ROOT / "custom_scripts/validate_syntax.py",
